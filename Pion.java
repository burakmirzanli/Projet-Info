...
public class Pion extends Piece implements interfaceValidite{
	...
	public boolean deplacementValid(int departL, int departC, int arriveeL, int arriveeC){		
		...
		if(departL-arriveeL<0 && this.couleur=="Noir"){
			...
			if(departL == 1 && Math.abs(departL-arriveeL)==2 && Math.abs(departC-arriveeC)==0 && (e1.getBoutonPlateau(arriveeC,arriveeL-1)).getPiece()==null){
				valid = true;
			} 
		}
		...
		if(departL-arriveeL>0 && this.couleur=="Blanc"){
			...
			if(departL == 6 && Math.abs(departL-arriveeL)==2 && Math.abs(departC-arriveeC)==0 && (e1.getBoutonPlateau(arriveeC,arriveeL+1)).getPiece()==null){
				valid = true;
			}
		}
